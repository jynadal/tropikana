...
function ToggleSidebar() {
    ...
    return(
        <Fragment>
		 <div  className="blog_right_toggle_sidebar">
            <div  className="outer_close"></div>
            <div  className="blog_togglediv">
                <a href="javascript:;"  className="toggle_close"></a>
                <div  className="blog_sidebar">
                    <div  className="widget widget_social">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_pink">CONNECT</h3>
                            </div>
                        </div>
                        <ul>
                            <li>
                                <div  className="widget_social_link">
                    ...
                    <div  className="widget widget_recent_post">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_orange">What’s hot</h3>
                            </div>
                        </div>
                        <ul>
                            <li>
                                <div  className="blog_recent_post">
                                    <div  className="blog_recent_post_img">
                                        <img src="https://via.placeholder.com/50x50"  className="img-fluid" alt="" />
                                    </div>
                                    <div  className="blog_recent_post_content">
                    ...
                    <div  className="widget widget_instagram_news">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_pink">Instagram</h3>
                            </div>
                        </div>
                        <ul>
                            <li>
                                <a href="#"><img src="https://via.placeholder.com/75x75"  className=
                                "img-fluid" alt="" /></a>
                                <div  className="blog_overlay"></div>
                                <div  className="blog_overlay_btndiv"><a href="images/placehold.jpg"  className="fa fa-search blog_popup"></a></div>
                            </li>
                            <li>
                                <a href="#"><img src="https://via.placeholder.com/75x75"  className=
                                "img-fluid" alt="" /></a>
                    ...
                    <div  className="widget widget_categories">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_lightgreen">categories</h3>
                            </div>
                        </div>
                        <ul>
                    ...
                    <div  className="widget widget_special_post">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_pink">don't miss</h3>
                            </div>
                        </div>
                        <ul>
                            <li>
                                <div  className="blog_post_slider_wrapper"> 
                                    <a href="blog_single_fullwidth.html"  className="blog_post_slider_img"> 
                                        <img src="https://via.placeholder.com/230x218"  className="img-fluid" alt="" /> 
                                    </a> 
                    ...
                    <div  className="widget widget_archive">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_blue">Archives</h3>
                            </div>
                        </div>
                        <ul>
                            <li>
                    ...
                    <div  className="widget widget_newsletter">
                        <div  className="blog_main_heading_div">
                            <div  className="blog_heading_div">
                                <h3  className="blog_bg_pink">Subscribe</h3>
                            </div>
                        </div>
                        <div  className="blog_newsletter">
                            ...
                            {/* <form  className="form-inline">
                                ...
                                <button type="button"  className="blog_newsletter_btn"><svg xmlns="http://www.w3.org/2000/svg" width="17px" height="16px"><path fill-rule="evenodd"  fill="rgb(255, 255, 255)" d="M16.914,0.038 C16.838,-0.030 16.731,-0.046 16.639,-0.002 L0.147,7.802 C0.058,7.844 0.001,7.934 0.000,8.034 C-0.001,8.134 0.054,8.225 0.142,8.269 L4.810,10.602 C4.895,10.645 4.997,10.635 5.074,10.577 L9.611,7.123 L6.049,10.855 C5.998,10.908 5.972,10.981 5.978,11.055 L6.333,15.760 C6.340,15.864 6.409,15.953 6.507,15.986 C6.533,15.994 6.560,15.999 6.586,15.999 C6.659,15.999 6.729,15.967 6.778,15.909 L9.256,12.986 L12.318,14.476 C12.384,14.508 12.461,14.509 12.529,14.480 C12.597,14.449 12.648,14.391 12.670,14.320 L16.989,0.310 C17.019,0.212 16.990,0.105 16.914,0.038 Z"/></svg></button>
                            </form> */}
                        </div>
                    </div>
                    <div  className="ads_widget">
                        <a href="#"><img src="https://via.placeholder.com/270x350?text=Ads%20Area"  className="img-fluid" alt="" /></a>
                    </div>
                </div>
            </div>
            </div>
