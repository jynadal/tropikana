...
function TopHeader() {
    ...
    return(
        <Fragment>
			<div  className="blog_top_header_wrapper">
                    <div  className="blog_date_div">
                    ...
                    <div  className="blog_temperature_div">
                    ...
                    <div  className="blog_user_div">
                        <a href="#"><img src="https://via.placeholder.com/34x34"  className="img-fluid" alt="" /> Jhon D. <i  className="fa fa-angle-down" aria-hidden="true"></i></a>
                        <div  className="blog_profile_div">
                            <ul>
                                <li>
